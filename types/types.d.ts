...
export type JobCategory = 'creative' | 'analytical' | 'physical' | 'research' | 'technical' | 'administrative' | 'consulting' | 'writing' | 'design' | 'development' | 'translation' | 'data' | 'marketing' | 'legal' | 'other';
export type JobStatus = 'draft' | 'active' | 'assigned' | 'in_progress' | 'completed' | 'cancelled' | 'disputed';
...
export type ContractStatus = 'active' | 'completed' | 'cancelled' | 'disputed' | 'paused';
...
export type MilestoneStatus = 'pending' | 'in_progress' | 'submitted' | 'approved' | 'paid' | 'revision_requested';
